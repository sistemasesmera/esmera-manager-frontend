...
export default function TableContracts() {
      ...
      try {
        const response = await axiosInstance.get("contracts", {
          ...
          params: {
            page: currentPage,
            limit: itemsPerPage,
            q: searchTerm || undefined, // solo envía q si hay texto
          },
        });

        if (!isMounted) return;

        // adapta según la estructura que devuelve tu backend
  ...
  }, [currentPage, searchTerm]); // dispara cuando cambia página o searchTerm
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  setCurrentPage(1); // resetea a la página 1 al cambiar búsqueda
                }}
